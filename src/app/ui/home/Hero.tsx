          ...
          <div className="grid grid-cols-12 gap-6 md:pt-36">
            ...
            >
              <h1 className="md:text-5xl text-3xl font-extrabold text-white text-center mb-6 md:px-0 px-1 capitalize">
                {language === 'english' ? 'Honoring tradition, building for the future' : 'भविष्याच्या निर्मितीच्या दिशेने परंपरेचा सन्मान'}
              </h1>
              <p className="md:text-xl text-base leading-normal text-center md:px-28">
                {language === 'english' ? 'We blend traditional artistry with modern techniques to craft majestic temples. Witness our dedication and craftsmanship in every temple we build.' : 'आम्ही पारंपरिक कला आणि आधुनिक तंत्रांचा संगम करून भव्य मंदिरांची निर्मिती करतो. आमच्या बांधलेल्या प्रत्येक मंदिरात आमचे समर्पण आणि कुशलता पहा.'}
              </p>
            </motion.div>
