      ...
      <div className="px-4 mx-auto md:px-24 lg:px-8 sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
        <div className="flex flex-col lg:items-center lg:flex-row lg:max-w-4xl">
          <div className="flex items-center mb-6 lg:w-1/3 lg:mb-0">
            <div className="flex items-center justify-center mb-6 w-14 h-14 mr-5 rounded-full bg-indigo-50 sm:w-24 sm:h-24 xl:mr-15 xl:w-24 xl:h-24">
              <FaBullseye size={60} />
            </div>
            <h3 className="md:text-4xl text-3xl font-extrabold text-[#254736]">
              Vision
            </h3>
          </div>
