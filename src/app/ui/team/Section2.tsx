        ...
        <div className="flex justify-center gap-4">
          ...
          <Link href="/portfolio">
            <button type="button" className="text-white bg-gray font-medium rounded-lg text-Paragraph_sm px-5 py-2.5 ">
              {language === 'english' ? 'Our Work' : 'आमचा काम'}
            </button>
          </Link>
