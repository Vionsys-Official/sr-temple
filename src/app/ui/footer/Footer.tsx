  ...
  return (
    <footer className="px-4 w-[100vw] overflow-hidden bg-slate-300  z-10 text-black">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex md:flex-row flex-col md:gap-24 gap-4 justify-center items-center w-full md:px-20 px-2 ">
        ...
        <hr />
        <div className="flex md:flex-row flex-col md:gap-20 gap-4 md:pl-16 pl-0 py-2 ">
          ...
          <div className="md:w-[40%] w-full">
            <div className="flex-1 justify-center items-center text-center md:w-auto w-full pb-2">
              <div className="bg-white shadow-lg rounded-lg py-10 transform transition duration-300 ease-in-out hover:scale-105 hover:shadow-2xl">
                <div className="w-full flex justify-center items-center sm:px-2">
                  <Link href="/about" passHref>
                    <div className="flex text-center text-gray md:text-SubHeading text-xl font-bold cursor-pointer">
                      SR Temple Construction
                    </div>
                  </Link>
                </div>
                <div className="w-full flex justify-center items-center sm:px-2">
                  <p className="text-base md:w-[90%] w-full py-2">
          ...
          {/* right side */}
          <div className="md:w-[50%] w-full flex md:flex-row flex-col gap-4">
            {/* Our Services */}
            ...
            <div className="flex flex-col ">
              <div className="w-full md:text-center text-start md:pl-0 pl-4">
                <h1 className="md:text-SubHeading text-xl text-gray font-bold mb-2">
                  Follow Us on Social Media
                </h1>

              </div>
              <div className="flex gap-4 md:justify-center  text-start md:pl-0 pl-4 md:px-6 py-6">
                <Link href="/" passHref>
