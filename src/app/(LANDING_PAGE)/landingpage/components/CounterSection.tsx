...
function CounterSection() {
  ...
  return (
    <div className="px-4 py-2 mx-auto  sm:max-w-full md:max-w-full lg:max-w-screen-xl md:px-4 lg:px-8 lg:py-3 lg:mb-3">
      ...
      >
        <h2 className="md:max-w-lg text-center text-MainHeading text-yellow font-MainHeading tracking-tight md:mx-auto">
          Decades of Experience, Timeless Quality
        </h2>
      </motion.div>
      <div className="">
        <section className="flex justify-center items-center" ref={sectionRef}>
          {/* 2nd section */}
          <div className="flex w-full md:flex-row flex-col gap-6 justify-center items-center border p-10 bg-[#254736] shadow-md rounded-md shadow-[#254736]">
            {arr.map((item) => (
              <div
                key={item.id}
